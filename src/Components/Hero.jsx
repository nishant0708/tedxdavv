...
function Hero() {
    ...
    return (
        ...
        <div>
            ...
            <div
            ref={bgRef} 
            className="pl-[5%] h-screen w-screen bg-[url('https://i.imgur.com/15kLXCo.jpg')] bg-contain hidden sm:block">
                {/* <Tween from={{ opacity: 0 }} to={{ opacity: 1 }} duration={2} ease="power1.out"> */}
                {/* <img src="https://i.imgur.com/15kLXCo.jpg" alt="" className="w-full h-auto bg-clip overflow-clip absolute" /> */}
                ...
                <div className="flex justify-center">
                    ...
                    alt="tedx-davv-logo" 
                    className="w-48 h-48 top-[8rem] relative scale-[280%]" />
                </div>

                <div className="">
                    <img 
                    ref={planetRef}
                    src="https://i.imgur.com/ud5pNJs.png" 
                    alt="Planet" 
                    className="relative left-[66rem] top-[-10rem] h-24" />
                </div>

                <img 
                ref={cloudRef}
                src="https://i.imgur.com/iEkwjMj.png" 
                alt="Clouds" 
                className="relative w-auto h-64 left-[32.5rem] bottom-36 scale-[400%] overflow-hidden" />
                ...
                alt="Plane" 
                className="relative h-24 left-[4rem] bottom-[30.6rem] scale-[150%]" />
                </div>
                ...
                alt="Balloon" 
                className="relative h-24 left-[31.25rem] bottom-[24.3rem] scale-[500%]" />
                ...
                alt="Rnth" 
                className="relative h-24 left-[18.1rem] bottom-[6.25rem] scale-[450%] sm:max-md:absolute sm:max-md:bottom-[17rem] sm:max-lg:left-0" />
                
                <img
                ref={adminRef} 
                src="https://i.imgur.com/2k6zadm.png" 
                alt="admin-building" 
                className="absolute h-24 right-[0] bottom-[23rem] scale-[350%] block sm:max-md:bottom-[18rem] 2xl:right-[28.125rem]" />

                <img 
                ref={cloud2Ref}
                src="https://assets.codepen.io/721952/cloud1.png" 
                alt="cloud-2" 
                className="relative w-auto h-56 left-[31.25rem] bottom-[32.5rem] scale-[550%] z-20" />
                </div>
                ...
                alt="rocket" 
                className="relative w-auto h-96 left-[67.5rem] bottom-[61.25rem]" />

                <img
                ref={comRef} 
                src="https://i.imgur.com/kkSsQ9a.png" 
                alt="com-building" 
                className="relative w-auto h-72 left-[31.875rem] bottom-[54.375rem] z-0 sm:max-[1200px]:hidden" />

                <img
                ref={alumniRef} 
                src="https://i.imgur.com/B2I3OXn.png" 
                alt="alumni" 
                className="relative w-auto h-96 left-[63.5rem] bottom-[75.25rem] hidden z-20 xl:block" />

                <img
                ref={ablockRef} 
                src="https://i.imgur.com/EFmjd5I.png" 
                alt="a-block" 
                className="relative w-auto h-96 left-[66.5rem] bottom-[109.25rem] hidden xl:block" />

                <img 
                ref={maincloudRef}
                src="https://assets.codepen.io/721952/cloud3.png" 
                alt="main-cloud" 
                className="absolute overflow-hidden w-[180rem] h-[auto] scale-[105%] right-[2.4rem] bottom-[0] z-40 hidden md:block" />
                {/* </Tween> */}
            </div>
        </div>
